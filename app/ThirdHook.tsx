  ...
  return (
    <div className={`w-full flex flex-col justify-center items-center mt-32 ${outfit.className} ${outfit.variable}`}>
      ...
      <div ref={cardsRef} className="mt-12 flex flex-row justify-center items-center">
        ...
        <div
          className={`w-72 h-64 m-8 p-8 bg-[#1E1E1E] rounded-4xl transform transition-all duration-700 ${
        ...
        >
          ...
          <p className="mt-4 text-sm text-[#8e8c8c]">
            Real-time finality using our<br/>
            proprietary Optimistic Bridges.<br/>
            Assests arrive before you can<br/>
            refresh your wallet.
          </p>
        </div>
        ...
        >
          ...
          <p className="mt-4 text-sm text-[#8e8c8c]">
            Algorithmic gas optimization<br/>
            reduces costs by 99% compared to<br/>
            mainnet. Pay in any stablecoin or<br/>
            native token.
          </p>
        </div>
      ...
      <div className="w-250 h-96 mt-24 flex flex-row justify-between rounded-4xl p-16">
        <div>
          ...
          <p className="mt-8">
            Secure your dev access today and start integrating global liquidity inti<br />
            your apps.
          </p>
        </div>
        <div className="mt-16">
